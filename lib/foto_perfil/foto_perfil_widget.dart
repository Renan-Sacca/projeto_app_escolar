...
class FotoPerfilWidget extends StatefulWidget {
  ...
  static String routeName = 'foto_perfil';
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed(VariaveisWidget.routeName);
            },
          ),
          title: Text(
            'Alterar foto perfil',
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              FFButtonWidget(
                onPressed: () async {
                  FFAppState().imagemteste = _model.uploadedFileUrl;
                  safeSetState(() {});
                },
                text: 'Salvar foto',
              ...
              StreamBuilder<List<PhotosRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<PhotosRecord> listViewPhotosRecordList = snapshot.data!;

                  return ListView.builder(
                    padding: EdgeInsets.zero,
                    shrinkWrap: true,
                    scrollDirection: Axis.vertical,
                    itemCount: listViewPhotosRecordList.length,
                    itemBuilder: (context, listViewIndex) {
                      final listViewPhotosRecord =
                          listViewPhotosRecordList[listViewIndex];
                      return ClipRRect(
                        borderRadius: BorderRadius.circular(8.0),
                        child: Image.network(
                          listViewPhotosRecord.imagem,
                          width: 200.0,
                          height: 200.0,
                          fit: BoxFit.cover,
                        ),
